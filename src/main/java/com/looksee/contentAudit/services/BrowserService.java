...
import com.looksee.contentAudit.models.enums.TemplateType;
import com.looksee.contentAudit.gcp.CloudVisionUtils;
import com.looksee.contentAudit.gcp.GoogleCloudStorage;
import com.looksee.contentAudit.models.Browser;
import com.looksee.contentAudit.models.BrowserConnectionHelper;
import com.looksee.contentAudit.models.ElementState;
import com.looksee.contentAudit.models.ImageElementState;
import com.looksee.contentAudit.models.ImageFaceAnnotation;
import com.looksee.contentAudit.models.ImageLandmarkInfo;
import com.looksee.contentAudit.models.ImageSafeSearchAnnotation;
import com.looksee.contentAudit.models.ImageSearchAnnotation;
import com.looksee.contentAudit.models.Label;
import com.looksee.contentAudit.models.Logo;
import com.looksee.contentAudit.models.PageState;
import com.looksee.contentAudit.models.Template;
...
public class BrowserService {
	...
	public Map<String, Template> findTemplates(List<com.looksee.contentAudit.models.Element> element_list){
		//create a map for the various duplicate elements
		Map<String, Template> element_templates = new HashMap<>();
		List<com.looksee.contentAudit.models.Element> parents_only_element_list = new ArrayList<>();
		for(com.looksee.contentAudit.models.Element element : element_list) {
			if(!element.isLeaf()) {
		...
		for(int idx1 = 0; idx1 < parents_only_element_list.size()-1; idx1++){
			com.looksee.contentAudit.models.Element element1 = parents_only_element_list.get(idx1);
			...
			for(int idx2 = idx1+1; idx2 < parents_only_element_list.size(); idx2++){
				com.looksee.contentAudit.models.Element element2 = parents_only_element_list.get(idx2);
