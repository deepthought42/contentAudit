package com.looksee.audit.contentAudit.services;
...
import com.looksee.audit.contentAudit.gcp.CloudVisionUtils;
import com.looksee.audit.contentAudit.gcp.GoogleCloudStorage;
import com.looksee.audit.contentAudit.models.Browser;
import com.looksee.audit.contentAudit.models.BrowserConnectionHelper;
import com.looksee.audit.contentAudit.models.ElementState;
import com.looksee.audit.contentAudit.models.ImageElementState;
import com.looksee.audit.contentAudit.models.ImageFaceAnnotation;
import com.looksee.audit.contentAudit.models.ImageLandmarkInfo;
import com.looksee.audit.contentAudit.models.ImageSafeSearchAnnotation;
import com.looksee.audit.contentAudit.models.ImageSearchAnnotation;
import com.looksee.audit.contentAudit.models.Label;
import com.looksee.audit.contentAudit.models.Logo;
import com.looksee.audit.contentAudit.models.PageState;
import com.looksee.audit.contentAudit.models.Template;
...
import com.looksee.audit.contentAudit.models.enums.ElementClassification;
import com.looksee.audit.contentAudit.models.enums.TemplateType;
...
public class BrowserService {
	...
	public Map<String, Template> findTemplates(List<com.looksee.audit.contentAudit.models.Element> element_list){
		//create a map for the various duplicate elements
		Map<String, Template> element_templates = new HashMap<>();
		List<com.looksee.audit.contentAudit.models.Element> parents_only_element_list = new ArrayList<>();
		for(com.looksee.audit.contentAudit.models.Element element : element_list) {
			if(!element.isLeaf()) {
		...
		for(int idx1 = 0; idx1 < parents_only_element_list.size()-1; idx1++){
			com.looksee.audit.contentAudit.models.Element element1 = parents_only_element_list.get(idx1);
			...
			for(int idx2 = idx1+1; idx2 < parents_only_element_list.size(); idx2++){
				com.looksee.audit.contentAudit.models.Element element2 = parents_only_element_list.get(idx2);
